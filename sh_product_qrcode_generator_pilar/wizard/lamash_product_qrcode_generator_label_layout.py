...
class ShProductQRCodeGeneratorLabelLayout(models.TransientModel):
    ...
    print_format = fields.Selection([
        ...
        ('bap_2x7', 'BAP Control (2x7 Label)'), ], string="Format", default='2x7xprice', required=True)
    ...
    def _prepare_report_data(self):
        ...
        elif 'bap_2x7' in self.print_format:
            xml_id = 'sh_product_qrcode_generator.report_bap_control_label_2x7'
        else:
            xml_id = ''
